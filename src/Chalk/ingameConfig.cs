...
internal static class IngameConfig
{
    ...
    private static readonly ConfigEntry<bool>[] Toggleables = [Chalk.windBursts, Chalk.minedLootboxes, Chalk.holeMinefield, Chalk.ballSwap, Chalk.instaKills, Chalk.extraLoots, Chalk.airHornExtra, Chalk.mineChain];
